...
_$PlayerModelImpl _$$PlayerModelImplFromJson(Map<String, dynamic> json) =>
    _$PlayerModelImpl(
      ...
      onPosition: json['onPosition'] as bool?,
      positionNumber: (json['positionNumber'] as num?)?.toInt(),
      lineupNumber: (json['lineupNumber'] as num?)?.toInt(),
...
Map<String, dynamic> _$$PlayerModelImplToJson(_$PlayerModelImpl instance) =>
    <String, dynamic>{
      ...
      'onPosition': instance.onPosition,
      'positionNumber': instance.positionNumber,
      'lineupNumber': instance.lineupNumber,
